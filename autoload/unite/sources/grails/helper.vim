...
"
function! unite#sources#grails#helper#gather_candidates_file(path)
...
"
function! unite#sources#grails#helper#gather_candidates_cmd(command, arguments)
...
"
function! unite#sources#grails#helper#gather_candidates_cmd_input(command, arguments) 
  return map(a:arguments , '{
        \ "word" : v:val.word ,
        \ "abbr" : get(v:val, "abbr", v:val.word) ,
        \ "kind" : "command" ,
...
function! s:create_cmd_input(cmd, word, abbr)
  return "call unite#sources#grails#helper#execute_cmd_input('". a:.cmd . "','" . a:word . "','" . a:abbr . "')"
endfunction

function! unite#sources#grails#helper#execute_cmd_input(cmd, word, abbr)
...
function! s:execute_cmd()
  if g:unite_grails_execute_cmd == '!'
    return '!'
  else
    return g:unite_grails_execute_cmd . ' '
  endif
endfunction

"
" get grails root directory
"
function! unite#sources#grails#helper#grails_root()
  let dir = finddir("grails-app" , ".;")
  if dir == "" | return "" | endif
  return  dir . "/../"
endfunction
